...
- I have use MySql database for this project with Prisma. But any other database, can be used by changing the `DATABASE_URL` in the `.env` file. and also changing the provider in `schema.prisma` file. Also another ORM like TypeORM can be used.
